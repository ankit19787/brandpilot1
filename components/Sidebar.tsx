...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onAction, handleLogout, userPlan, onPlanUpgrade }) => {
  ...
  const allNavItems = [
    ...
    { id: 'calendar', label: 'Content Calendar', icon: Calendar, minPlan: 'pro' },
    { id: 'connections', label: 'Connections', icon: Link2, minPlan: 'free' },
    { id: 'credentials', label: 'API Credentials', icon: Key, minPlan: 'pro' },
    { id: 'performance', label: 'Performance', icon: BarChart3, minPlan: 'free' },
    { id: 'platform-responses', label: 'Platform Responses', icon: MessageSquareText, minPlan: 'pro' },
    ...
    { id: 'email-logs', label: 'Email Logs', icon: Mail, minPlan: 'pro' },
    { id: 'manage-users', label: 'Manage Users', icon: Users, minPlan: 'pro' },
